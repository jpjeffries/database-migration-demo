...
// Buckets
output "db-export-storage-bucket-url" {
  value       = "${google_storage_bucket.db-export-store.url}"
  description = "The db export storage bucket url"
}

output "db-export-storage-bucket-selflink" {
  value       = "${google_storage_bucket.db-export-store.self_link}"
  description = "The db export storage bucket self link uri"
}
